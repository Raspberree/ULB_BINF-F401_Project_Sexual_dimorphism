...
Conclusion: technical variables that we will take into account: SEX + RNA_DI + HARDY_SCALE
...
1. Separate male and female samples ? --> Do a differential expression analysis with DESeq2 (design / formula = confounding technical variables + rna_dimorphism_index) --> look at the differentially expressed genes --> vocano plot
