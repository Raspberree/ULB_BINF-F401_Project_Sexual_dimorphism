...
The data (in the "data" and "resources" folders) and the code ("report.qmd" file) are available in this [GitHub repository](https://github.com/Raspberree/ULB_BINF-F401_Project_Sexual_dimorphism.git).
